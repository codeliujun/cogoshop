...
+ (UIImage *)qrImageForString:(NSString *)string imageSize:(CGFloat)size {
    ...
    [LIUCreatQRCode drawQRCode:code context:ctx size:size];
...
+ (UIImage *) avatarImage:(UIImage *)avatarImage{
    ...
    //UIImage * avatarBackgroudImage = [UIImage imageNamed:@"cust_level_normal.png"];//这个是背景的图
    
    //CGSize size = avatarBackgroudImage.size;
    CGSize size = CGSizeMake(_size/5.0, _size/5.0);
